...
static Status write_be_configs_table(const StarRocksNodesInfo& nodes_info, int64_t self_be_id,
...
Status SchemaTableSink::send_chunk(RuntimeState* state, vectorized::Chunk* chunk) {
