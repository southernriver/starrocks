...
HdfsScanner* HiveDataSource::_create_rcfile_jni_scanner(HdfsScannerParams* scanner_params) {
    ...
    std::string scanner_factory_class = "com/starrocks/rcfile/reader/RCFileSliceScannerFactory";
