...
ColumnPtr StringFunctions::url_encode(FunctionContext* context, const Columns& columns) {
...
ColumnPtr StringFunctions::url_decode(FunctionContext* context, const Columns& columns) {
