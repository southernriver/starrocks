...
public:
    TabletSinkColocateSender(PUniqueId load_id, int64_t txn_id, OlapTableLocationParam* location,
                             vectorized::OlapTablePartitionParam* vectorized_partition,
...
public:
    Status send_chunk(const OlapTableSchemaParam* schema,
                      const std::vector<vectorized::OlapTablePartition*>& partitions,
                      ...
                      vectorized::Chunk* chunk) override;
...
protected:
    Status _send_chunks(const OlapTableSchemaParam* schema, vectorized::Chunk* chunk,
