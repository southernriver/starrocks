...
TEST_F(CSVScannerTest, test_adaptive_nullable_column1) {
...
TEST_F(CSVScannerTest, test_adaptive_nullable_column2) {
    std::vector<TypeDescriptor> types{TypeDescriptor(TYPE_INT), TypeDescriptor(TYPE_VARCHAR), TypeDescriptor(TYPE_INT)};
...
TEST_F(CSVScannerTest, test_adaptive_nullable_column3) {
    std::vector<TypeDescriptor> types{TypeDescriptor(TYPE_INT), TypeDescriptor(TYPE_VARCHAR), TypeDescriptor(TYPE_INT)};
