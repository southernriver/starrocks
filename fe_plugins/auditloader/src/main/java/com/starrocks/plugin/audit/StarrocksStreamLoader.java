...
public class StarrocksStreamLoader {
    ...
    private HttpURLConnection getConnection(String urlStr, String label) throws IOException {
        ...
        conn.addRequestProperty("columns", "query_id, time, client_ip, user, resource_group, catalog, db, state, error_code, query_time, scan_bytes, scan_rows, return_rows, cpu_cost_ns, mem_cost_bytes, stmt_id, is_query, frontend_ip, stmt, digest, plan_cpu_costs, plan_mem_costs, exception");
    ...
    private String toCurl(HttpURLConnection conn) {
        ...
        sb.append("-H \"").append("columns\":").append("\"query_id, time, client_ip, user, resource_group, catalog, db, table, state, error_code, query_time, scan_bytes, scan_rows, return_rows, cpu_cost_ns, mem_cost_bytes, stmt_id, is_query, frontend_ip, stmt, digest, plan_cpu_costs, plan_mem_costs, exception\" \\\n  ");
