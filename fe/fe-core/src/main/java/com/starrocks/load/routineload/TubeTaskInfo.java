...
public class TubeTaskInfo extends RoutineLoadTaskInfo {
    ...
    public TubeTaskInfo(UUID id, long jobId, long taskScheduleIntervalMs, long timeToExecuteMs,
    ...
    public TubeTaskInfo(long timeToExecuteMs, TubeTaskInfo tubeTaskInfo) {
        super(UUID.randomUUID(), tubeTaskInfo.getJobId(), tubeTaskInfo.getTaskScheduleIntervalMs(),
                timeToExecuteMs, tubeTaskInfo.getBeId());
