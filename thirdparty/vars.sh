...
TUBE_NAME=tubemq-master-20220908.tar.gz
TUBE_SOURCE=tubemq-master-20220908
TUBE_MD5SUM="ebeb8901d9de5b72ea8742b5e0c3abbe"
...
TP_ARCHIVES="LIBEVENT OPENSSL THRIFT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SIMDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP CURL \
            RE2 BOOST LEVELDB BRPC ROCKSDB LIBRDKAFKA PULSAR TUBE FLATBUFFERS ARROW BROTLI ZSTD S2 BITSHUFFLE CROARINGBITMAP \
