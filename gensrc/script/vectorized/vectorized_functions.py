...
vectorized_functions = [
    ...
    [30331, 'replace', 'VARCHAR', ['VARCHAR', 'VARCHAR', 'VARCHAR'], 'StringFunctions::regexp_replace',
     'StringFunctions::regexp_replace_prepare', 'StringFunctions::regexp_close'],
    [30332, 'plain_replace', 'VARCHAR', ['VARCHAR', 'VARCHAR', 'VARCHAR'], 'StringFunctions::plain_replace'],
    ...
    [80040, 'base64_to_hll', 'HLL', ['VARCHAR'], 'HyperloglogFunction::base64_to_hll'],
    ...
    [150400, 'array_auc', 'DOUBLE',  ['ARRAY_TINYINT', 'ARRAY_TINYINT'],   'ArrayFunctions::array_auc_tint2tint'],
    [150401, 'array_auc', 'DOUBLE',  ['ARRAY_TINYINT', 'ARRAY_SMALLINT'],   'ArrayFunctions::array_auc_tint2sint'],
    [150402, 'array_auc', 'DOUBLE',  ['ARRAY_TINYINT', 'ARRAY_INT'],   'ArrayFunctions::array_auc_tint2int'],
    [150403, 'array_auc', 'DOUBLE',  ['ARRAY_TINYINT', 'ARRAY_BIGINT'],   'ArrayFunctions::array_auc_tint2bint'],
    [150404, 'array_auc', 'DOUBLE',  ['ARRAY_TINYINT', 'ARRAY_LARGEINT'],   'ArrayFunctions::array_auc_tint2lint'],
    [150405, 'array_auc', 'DOUBLE',  ['ARRAY_TINYINT', 'ARRAY_FLOAT'],   'ArrayFunctions::array_auc_tint2float'],
    [150406, 'array_auc', 'DOUBLE',  ['ARRAY_TINYINT', 'ARRAY_DOUBLE'],   'ArrayFunctions::array_auc_tint2double'],
    [150407, 'array_auc', 'DOUBLE',  ['ARRAY_TINYINT', 'ARRAY_DECIMALV2'],   'ArrayFunctions::array_auc_tint2decimal'],

    [150408, 'array_auc', 'DOUBLE',  ['ARRAY_SMALLINT', 'ARRAY_TINYINT'],   'ArrayFunctions::array_auc_sint2tint'],
    [150409, 'array_auc', 'DOUBLE',  ['ARRAY_SMALLINT', 'ARRAY_SMALLINT'],   'ArrayFunctions::array_auc_sint2sint'],
    [150410, 'array_auc', 'DOUBLE',  ['ARRAY_SMALLINT', 'ARRAY_INT'],   'ArrayFunctions::array_auc_sint2int'],
    [150411, 'array_auc', 'DOUBLE',  ['ARRAY_SMALLINT', 'ARRAY_BIGINT'],   'ArrayFunctions::array_auc_sint2bint'],
    [150412, 'array_auc', 'DOUBLE',  ['ARRAY_SMALLINT', 'ARRAY_LARGEINT'],   'ArrayFunctions::array_auc_sint2lint'],
    [150413, 'array_auc', 'DOUBLE',  ['ARRAY_SMALLINT', 'ARRAY_FLOAT'],   'ArrayFunctions::array_auc_sint2float'],
    [150414, 'array_auc', 'DOUBLE',  ['ARRAY_SMALLINT', 'ARRAY_DOUBLE'],   'ArrayFunctions::array_auc_sint2double'],
    [150415, 'array_auc', 'DOUBLE',  ['ARRAY_SMALLINT', 'ARRAY_DECIMALV2'],   'ArrayFunctions::array_auc_sint2decimal'],

    [150416, 'array_auc', 'DOUBLE',  ['ARRAY_INT', 'ARRAY_TINYINT'],   'ArrayFunctions::array_auc_int2tint'],
    [150417, 'array_auc', 'DOUBLE',  ['ARRAY_INT', 'ARRAY_SMALLINT'],   'ArrayFunctions::array_auc_int2sint'],
    [150418, 'array_auc', 'DOUBLE',  ['ARRAY_INT', 'ARRAY_INT'],   'ArrayFunctions::array_auc_int2int'],
    [150419, 'array_auc', 'DOUBLE',  ['ARRAY_INT', 'ARRAY_BIGINT'],   'ArrayFunctions::array_auc_int2bint'],
    [150420, 'array_auc', 'DOUBLE',  ['ARRAY_INT', 'ARRAY_LARGEINT'],   'ArrayFunctions::array_auc_int2lint'],
    [150421, 'array_auc', 'DOUBLE',  ['ARRAY_INT', 'ARRAY_FLOAT'],   'ArrayFunctions::array_auc_int2float'],
    [150422, 'array_auc', 'DOUBLE',  ['ARRAY_INT', 'ARRAY_DOUBLE'],   'ArrayFunctions::array_auc_int2double'],
    [150423, 'array_auc', 'DOUBLE',  ['ARRAY_INT', 'ARRAY_DECIMALV2'],   'ArrayFunctions::array_auc_int2decimal'],

    [150424, 'array_auc', 'DOUBLE',  ['ARRAY_BIGINT', 'ARRAY_TINYINT'],   'ArrayFunctions::array_auc_bint2tint'],
    [150425, 'array_auc', 'DOUBLE',  ['ARRAY_BIGINT', 'ARRAY_SMALLINT'],   'ArrayFunctions::array_auc_bint2sint'],
    [150426, 'array_auc', 'DOUBLE',  ['ARRAY_BIGINT', 'ARRAY_INT'],   'ArrayFunctions::array_auc_bint2int'],
    [150427, 'array_auc', 'DOUBLE',  ['ARRAY_BIGINT', 'ARRAY_BIGINT'],   'ArrayFunctions::array_auc_bint2bint'],
    [150428, 'array_auc', 'DOUBLE',  ['ARRAY_BIGINT', 'ARRAY_LARGEINT'],   'ArrayFunctions::array_auc_bint2lint'],
    [150429, 'array_auc', 'DOUBLE',  ['ARRAY_BIGINT', 'ARRAY_FLOAT'],   'ArrayFunctions::array_auc_bint2float'],
    [150430, 'array_auc', 'DOUBLE',  ['ARRAY_BIGINT', 'ARRAY_DOUBLE'],   'ArrayFunctions::array_auc_bint2double'],
    [150431, 'array_auc', 'DOUBLE',  ['ARRAY_BIGINT', 'ARRAY_DECIMALV2'],   'ArrayFunctions::array_auc_bint2decimal'],


    [150432, 'array_auc', 'DOUBLE',  ['ARRAY_LARGEINT', 'ARRAY_TINYINT'],   'ArrayFunctions::array_auc_lint2tint'],
    [150433, 'array_auc', 'DOUBLE',  ['ARRAY_LARGEINT', 'ARRAY_SMALLINT'],   'ArrayFunctions::array_auc_lint2sint'],
    [150434, 'array_auc', 'DOUBLE',  ['ARRAY_LARGEINT', 'ARRAY_INT'],   'ArrayFunctions::array_auc_lint2int'],
    [150435, 'array_auc', 'DOUBLE',  ['ARRAY_LARGEINT', 'ARRAY_BIGINT'],   'ArrayFunctions::array_auc_lint2bint'],
    [150436, 'array_auc', 'DOUBLE',  ['ARRAY_LARGEINT', 'ARRAY_LARGEINT'],   'ArrayFunctions::array_auc_lint2lint'],
    [150437, 'array_auc', 'DOUBLE',  ['ARRAY_LARGEINT', 'ARRAY_FLOAT'],   'ArrayFunctions::array_auc_lint2float'],
    [150438, 'array_auc', 'DOUBLE',  ['ARRAY_LARGEINT', 'ARRAY_DOUBLE'],   'ArrayFunctions::array_auc_lint2double'],
    [150439, 'array_auc', 'DOUBLE',  ['ARRAY_LARGEINT', 'ARRAY_DECIMALV2'],   'ArrayFunctions::array_auc_lint2decimal'],

    [150440, 'array_auc', 'DOUBLE',  ['ARRAY_FLOAT', 'ARRAY_TINYINT'],   'ArrayFunctions::array_auc_float2tint'],
    [150441, 'array_auc', 'DOUBLE',  ['ARRAY_FLOAT', 'ARRAY_SMALLINT'],   'ArrayFunctions::array_auc_float2sint'],
    [150442, 'array_auc', 'DOUBLE',  ['ARRAY_FLOAT', 'ARRAY_INT'],   'ArrayFunctions::array_auc_float2int'],
    [150443, 'array_auc', 'DOUBLE',  ['ARRAY_FLOAT', 'ARRAY_BIGINT'],   'ArrayFunctions::array_auc_float2bint'],
    [150444, 'array_auc', 'DOUBLE',  ['ARRAY_FLOAT', 'ARRAY_LARGEINT'],   'ArrayFunctions::array_auc_float2lint'],
    [150445, 'array_auc', 'DOUBLE',  ['ARRAY_FLOAT', 'ARRAY_FLOAT'],   'ArrayFunctions::array_auc_float2float'],
    [150446, 'array_auc', 'DOUBLE',  ['ARRAY_FLOAT', 'ARRAY_DOUBLE'],   'ArrayFunctions::array_auc_float2double'],
    [150447, 'array_auc', 'DOUBLE',  ['ARRAY_FLOAT', 'ARRAY_DECIMALV2'],   'ArrayFunctions::array_auc_float2decimal'],

    [150448, 'array_auc', 'DOUBLE',  ['ARRAY_DOUBLE', 'ARRAY_TINYINT'],   'ArrayFunctions::array_auc_double2tint'],
    [150449, 'array_auc', 'DOUBLE',  ['ARRAY_DOUBLE', 'ARRAY_SMALLINT'],   'ArrayFunctions::array_auc_double2sint'],
    [150450, 'array_auc', 'DOUBLE',  ['ARRAY_DOUBLE', 'ARRAY_INT'],   'ArrayFunctions::array_auc_double2int'],
    [150451, 'array_auc', 'DOUBLE',  ['ARRAY_DOUBLE', 'ARRAY_BIGINT'],   'ArrayFunctions::array_auc_double2bint'],
    [150452, 'array_auc', 'DOUBLE',  ['ARRAY_DOUBLE', 'ARRAY_LARGEINT'],   'ArrayFunctions::array_auc_double2lint'],
    [150453, 'array_auc', 'DOUBLE',  ['ARRAY_DOUBLE', 'ARRAY_FLOAT'],   'ArrayFunctions::array_auc_double2float'],
    [150454, 'array_auc', 'DOUBLE',  ['ARRAY_DOUBLE', 'ARRAY_DOUBLE'],   'ArrayFunctions::array_auc_double2double'],
    [150455, 'array_auc', 'DOUBLE',  ['ARRAY_DOUBLE', 'ARRAY_DECIMALV2'],   'ArrayFunctions::array_auc_double2decimal'],

    [150456, 'array_auc', 'DOUBLE',  ['ARRAY_DECIMALV2', 'ARRAY_TINYINT'],   'ArrayFunctions::array_auc_decimal2tint'],
    [150457, 'array_auc', 'DOUBLE',  ['ARRAY_DECIMALV2', 'ARRAY_SMALLINT'],   'ArrayFunctions::array_auc_decimal2sint'],
    [150458, 'array_auc', 'DOUBLE',  ['ARRAY_DECIMALV2', 'ARRAY_INT'],   'ArrayFunctions::array_auc_decimal2int'],
    [150459, 'array_auc', 'DOUBLE',  ['ARRAY_DECIMALV2', 'ARRAY_BIGINT'],   'ArrayFunctions::array_auc_decimal2bint'],
    [150460, 'array_auc', 'DOUBLE',  ['ARRAY_DECIMALV2', 'ARRAY_LARGEINT'],   'ArrayFunctions::array_auc_decimal2lint'],
    [150461, 'array_auc', 'DOUBLE',  ['ARRAY_DECIMALV2', 'ARRAY_FLOAT'],   'ArrayFunctions::array_auc_decimal2float'],
    [150462, 'array_auc', 'DOUBLE',  ['ARRAY_DECIMALV2', 'ARRAY_DOUBLE'],   'ArrayFunctions::array_auc_decimal2double'],
    [150463, 'array_auc', 'DOUBLE',  ['ARRAY_DECIMALV2', 'ARRAY_DECIMALV2'],   'ArrayFunctions::array_auc_decimal2decimal'],

    [150500, 'array_range', 'ARRAY_TINYINT',  ['TINYINT', 'TINYINT', 'TINYINT'],   'ArrayFunctions::array_range3_tinyint'],
    [150501, 'array_range', 'ARRAY_SMALLINT',  ['SMALLINT', 'SMALLINT', 'SMALLINT'],   'ArrayFunctions::array_range3_smallint'],
    [150502, 'array_range', 'ARRAY_INT',  ['INT', 'INT', 'INT'],   'ArrayFunctions::array_range3_int'],
    [150503, 'array_range', 'ARRAY_BIGINT',  ['BIGINT', 'BIGINT', 'BIGINT'],   'ArrayFunctions::array_range3_bigint'],
    [150504, 'array_range', 'ARRAY_LARGEINT',  ['LARGEINT', 'LARGEINT', 'LARGEINT'],   'ArrayFunctions::array_range3_largeint'],

    [150505, 'array_range', 'ARRAY_TINYINT',  ['TINYINT', 'TINYINT'],   'ArrayFunctions::array_range2_tinyint'],
    [150506, 'array_range', 'ARRAY_SMALLINT',  ['SMALLINT', 'SMALLINT'],   'ArrayFunctions::array_range2_smallint'],
    [150507, 'array_range', 'ARRAY_INT',  ['INT', 'INT'],   'ArrayFunctions::array_range2_int'],
    [150508, 'array_range', 'ARRAY_BIGINT',  ['BIGINT', 'BIGINT'],   'ArrayFunctions::array_range2_bigint'],
    [150509, 'array_range', 'ARRAY_LARGEINT',  ['LARGEINT', 'LARGEINT'],   'ArrayFunctions::array_range2_largeint'],

    [150510, 'array_range', 'ARRAY_TINYINT',  ['TINYINT'],   'ArrayFunctions::array_range_tinyint'],
    [150511, 'array_range', 'ARRAY_SMALLINT',  ['SMALLINT'],   'ArrayFunctions::array_range_smallint'],
    [150512, 'array_range', 'ARRAY_INT',  ['INT'],   'ArrayFunctions::array_range_int'],
    [150513, 'array_range', 'ARRAY_BIGINT',  ['BIGINT'],   'ArrayFunctions::array_range_bigint'],
    [150514, 'array_range', 'ARRAY_LARGEINT',  ['LARGEINT'],   'ArrayFunctions::array_range_largeint'],

    [150600, 'array_split', 'ANY_ARRAY',  ['ANY_ARRAY', 'ARRAY_BOOLEAN'],   'ArrayFunctions::array_split'],
